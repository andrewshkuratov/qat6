package com.epam.sum_university.uitests.scripts;
        ...
        import com.epam.sum_university.pageobject.pages.RunScriptsPage;
...
public class DBRunScript extends BaseTest {
    ...
    public void dBScriptUploadPositiv() throws IOException {
        ...
        String s = "/scripts/run"; boolean check;
        ...
        RunScriptsPage rp = userInformation.runScript();
        rp.capture(s);
        check = rp.scriptContainerIsDisplayed();
